// This file holds the Genkit flow for the AI-powered virtual assistant to answer questions about HCOM's services and initiatives.

'use server';

/**
 * @fileOverview An AI agent to answer questions about HCOM's services and initiatives.
 *
 * - aiAssistant - A function that handles the process of answering questions.
...
const AiAssistantInputSchema = z.object({
  question: z.string().describe('The question to be answered about HCOM services and initiatives.'),
});
export type AiAssistantInput = z.infer<typeof AiAssistantInputSchema>;

const AiAssistantOutputSchema = z.object({
  answer: z.string().describe('The answer to the question about HCOM services and initiatives.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI-powered virtual assistant for HCOM International Limited. Your job is to answer questions about HCOM's services and initiatives. Use the following information to answer the question.
